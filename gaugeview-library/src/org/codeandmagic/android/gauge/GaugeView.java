...
public class GaugeView extends View {
	...
	public void setDefaultRanges() {
		...
		mRangeColors = new int[] { Color.rgb(231, 32, 43),
				Color.rgb(232, 111, 33), Color.rgb(232, 231, 33),
				Color.rgb(27, 202, 33) };
	}
